...
%  Add ratings that correspond to a new user that was just observed. 
%
...
% Or suppose did not enjoy Silence of the Lambs (1991), can set
my_ratings(98) = 2;

% Random movie ratings added:
my_ratings(7) = 3;
my_ratings(12)= 5;
my_ratings(54) = 4;
my_ratings(64)= 5;
my_ratings(66)= 3;
my_ratings(69) = 5;
% my_ratings(96) = 5;     % Terminator 2 rox
my_ratings(183) = 4;
my_ratings(226) = 5;
my_ratings(355)= 5;
...
% randn(A,B) creates normally distributed pseudorandom numbers as AxB matrix  
