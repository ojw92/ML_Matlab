...
%  Implement a two layer neural network that classifies digits
...
%% =================== Part 8: Training NN ===================
% Use "fmincg" to train the neural network
...
%  Implement the "predict" function to use the neural network to predict
%  the labels of the training set. Compute the training set accuracy.
