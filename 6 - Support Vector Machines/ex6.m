...
%  After implementing the kernel, it can now be used to train the 
%  SVM classifier.
% 
...
% faster. However, in practice, run the training to convergence.
...
%  This is a different dataset that can be used to experiment with. Try
